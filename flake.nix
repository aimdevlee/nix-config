{
  ...
  outputs =
    ...
    let
      # Function to create a Darwin system configuration for a host
      mkDarwinSystem =
        hostname:
    ...
    {
      # Define all host configurations
      darwinConfigurations = {
        aimdevlee = mkDarwinSystem "aimdevlee";
        JRXNCW6L5J = mkDarwinSystem "JRXNCW6L5J";
        # Add more hosts here as needed
        # example-host = mkDarwinSystem "example-host";
      };
    }
